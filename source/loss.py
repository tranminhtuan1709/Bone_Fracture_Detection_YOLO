...
class YoloLoss(nn.Module):
    ...
    def forward(self, predictions: torch.Tensor, target: torch.Tensor) -> float:
        ...
        # predictions[..., 21:25] is the first predicted bounding box.
        # predictions[..., 26:30] is the second predicted bounding box.

        # target[..., 21:25] is the true bounding box (label).

        # predictions[..., 21:25].shape = (batch, 7, 7, 4)
        # predictions[..., 26:30].shape = (batch, 7, 7, 4)

        # target[..., 21:25].shape = (batch, 7, 7, 4)
        ...
        # 0 means that box predictions[..., 21:25] has higher IOU.
        # 1 means that box predictions[..., 26:30] has higher IOU.
        ...
        # bestbox * predictions[..., 26:30] is to keep second bounding boxes
        # that have higher IOU values than the first ones.

        # bestbox * predictions[..., 21:25] is to keep first bounding boxes
